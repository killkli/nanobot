...
<div class="hero-section">
  <img src="assets/logo.svg" class="hero-logo" alt="Nanobot Logo">
...
```mermaid
graph TD
    A["Chat Platforms<br/>(Telegram / Discord / Slack / ...)"] --> B["Message Bus<br/>nanobot/bus/"]
    B --> C["Agent Loop<br/>nanobot/agent/loop.py"]
    C --> D["Context Builder<br/>context.py"]
    C --> E["LLM Provider<br/>nanobot/providers/"]
    C --> F["Tool Execution<br/>nanobot/agent/tools/"]
    C --> G["Session Manager<br/>nanobot/session/"]
    E --> H["OpenAI / Anthropic<br/>Gemini / DeepSeek / ..."]
    F --> I["Shell / Web / Filesystem<br/>MCP / Cron / Spawn"]
    G --> J["Token-aware Memory<br/>nanobot/agent/memory.py"]
```
